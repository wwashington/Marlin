...
#define STRING_CONFIG_H_AUTHOR "(Winefred Washington, default config)" // Who made the changes.
...
#define MOTHERBOARD BOARD_CANDY_PRINTER
...
#define DEFAULT_NOMINAL_FILAMENT_DIA 25.0
...
#define DEFAULT_MAX_FEEDRATE          { 5, 5, 5, 2 }
...
#define DEFAULT_MAX_ACCELERATION      { 3, 3, 1, 100 }
